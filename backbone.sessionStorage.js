...
Backbone.SessionStorage = function(name) {
...
_.extend(Backbone.SessionStorage.prototype, {
  ...
  _clear: function() {
    ...
    // Remove id-tracking item
    local.removeItem(this.name);

    // Match all data items and remove.
...
Backbone.SessionStorage.sync = function(method, model, options) {
...
Backbone.classicSync = Backbone.sync;
...
Backbone.getSyncMethod = function(model) {
  ...
  return Backbone.classicSync;
};

// Override 'Backbone.sync' to default to localSync,
// the original 'Backbone.sync' is still available in 'Backbone.classicSync'
